    ...
    <div className="home-grid">
      <Card title={"Recent sales"}>
        <HomeCard
          title={"No Sales Data"}
          icon={<FaChartLine />}
          subtitle="Make some appointments for sales data to appear"
        />
      </Card>
      <Card title={"Upcoming appointments"}>
        <HomeCard
          ...
          icon={<FaChartBar />}
          subtitle={"Make some appointments for schedule data to appear"}
        />
      </Card>
      <Card title={"Appointments activity"}>
        <HomeCard
          ...
          subtitle={"Visit the calendar section to add some appointments"}
        />
      </Card>
      ...
      <Card title={"Top services"}>
        <HomeCard
          ...
          subtitle={"Create some sales for sales data to appear"}
        />
      </Card>
